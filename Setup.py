...
PROGRAM_DIRECTORY = "C:\\Heater_Test_Check"
...
def main(progress_var):
    program_dir = "C:\\Heater_Test_Check"
    ...
    icon_path = os.path.join(program_dir, "Resource", "ico.ico")
    ...
    target_path = r"C:\Heater_Test_Check\Main.exe"
    shortcut_path = os.path.join(winshell.desktop(), "Heater_Test_Check.lnk")
...
def get_data_path(relative_path):
    ...
    if not os.path.exists(data_path):
        ...
        install_path = r"C:\Heater_Test_Check"
...
class Ui_InextendChecker:
    ...
    def __init__(self, root):
        ...
        root.title(f"Heater Test Check setup")
        ...
        lbl_Name1 = tk.Label(root, text="HEATER TEST", font=("Arial", 22, "bold italic"))
        lbl_Name1.place(x=210, y=40, width=290, height=25)
        lbl_Name = tk.Label(root, text="CHECKER", font=("Arial", 22, "bold italic"))
        lbl_Name.place(x=350, y=70, width=240, height=25)

        lbl_detail = tk.Label(root, text="Trình cài đặt Heater Test Check lên máy tính của bạn.", font=("Arial", 12, "bold"), anchor='w')
